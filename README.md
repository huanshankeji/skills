...
| Skill | Description |
|---|---|
| [git-commit-after-review](skills/git-commit-after-review/) | Creates a Git commit for follow-up work after reviewing a commit, commit range, whole PR, or remaining unreviewed PR Files Changed; ask what was reviewed unless the user already named it; includes the full reviewed hash except when it was the parent commit |
